package com.firebase.custommap;
...
public class MainActivity extends FragmentActivity implements GeoQueryEventListener, GoogleMap.OnCameraChangeListener {
    ...
    private static final GeoLocation INITIAL_CENTER = new GeoLocation(37.7789, -122.4017); // custom fixed locaiton right now
    private static final int INITIAL_ZOOM_LEVEL = 14;
    // firebase server link for free acces of geo  
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setup markers -- baad me change kr skty h isko kis bi shape me
    ...
    public void onGeoQueryError(FirebaseError error) {
        new AlertDialog.Builder(this)
                .setTitle("Error")
                .setMessage("Something went wrong " + error.getMessage())
